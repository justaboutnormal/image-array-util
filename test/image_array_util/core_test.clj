...
(deftest rotate-image-test
  (testing "Rotate an image"
    (is (= (rotate-image [[1]] :90) [[1]]))
    (is (= (rotate-image [[[0 0 0]]] :90) [[[0 0 0]]]))
    (is (= (rotate-image [[1 2]] :90) [[2][1]]))
    (is (= (rotate-image [[[1 1 1][2 2 2]]] :90) [[[2 2 2]][[1 1 1]]]))
    (is (= (rotate-image [[1 2]] :180) [[2 1]]))
    (is (= (rotate-image [[[1 1 1][2 2 2]]] :180) [[[2 2 2][1 1 1]]]))
    (is (= (rotate-image [[[1 1 1][2 2 2][3 3 3]][[4 4 4][5 5 5][6 6 6]]] :270) [[ [4 4 4] [1 1 1]][[5 5 5][2 2 2]][[6 6 6][3 3 3]]]))
...
(deftest crop-image-test
  (testing "Cropping an image"
    (is (= (crop-image [[1]] [0 1] [0 1]) [[1]]))
    (is (= (crop-image [[1 2 3][4 5 6][7 8 9]] [0 1] [0 3]) [[1 2 3]]))
    (is (= (crop-image [[1 2 3][4 5 6][7 8 9]] [0 3] [0 1]) [[1][4][7]]))
    (is (= (crop-image [[1 2 3][4 5 6][7 8 9]] [1 2] [1 2]) [[5]]))
    (is (= (crop-image [[ [1 1 1] [2 2 2] [3 3 3]]
                        [ [4 4 4] [5 5 5] [6 6 6]]
